...
function App() {
      ...
      case 'etudiant':
        return (
          <div className="ml-10 w-full flex-1 p-8 bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="max-w-7xl mx-auto">
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-4">Étudiants</h1>
                <p className="text-gray-600">Gestion des étudiants (à venir)</p>
              </div>
            </div>
          </div>
        );
  ...
  return (
    <div className="flex left-0  absolute bottom-0 h-screen w-screen overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
